          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <ScrollReveal>
              <div>
                ...
                Founded by Nupur Patil Sawant in Nashik, DivinedazEvents specializes in designing bespoke, luxurious events that bring your vision to life. Whether it's an intimate gathering or a grand celebration, we ensure every detail is meticulously planned and executed.</p>
